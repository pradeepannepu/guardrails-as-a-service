...
\title{Guardrails-as-a-Service: Hybrid Deterministic and Semantic Policy Evaluation}

\author{
\IEEEauthorblockN{Pradeep Annepu, Rajesh Akula}
\IEEEauthorblockA{Email: \{M25AI1109, M25AI1109\}@iitj.ac.in}
}
...
\begin{figure}[htbp]
  \centerline{\includegraphics[width=\columnwidth]{hld_design.png}}
  \caption{System Architecture: Hybrid policy evaluation with event-driven decoupling}
  \label{fig:hld_design}
\end{figure}

Fig.~\ref{fig:hld_design} System Architecture
