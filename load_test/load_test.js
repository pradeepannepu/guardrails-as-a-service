...
const API_URL = "https://localhost:3001/test";
...
export function handleSummary(data) {
  ...
  console.log(
    "Test Duration:",
    data.metrics.iteration_duration.values.avg.toFixed(2),
    "ms (avg)"
  );
  ...
  console.log(
    "Success Rate:",
    (data.metrics.success?.values.rate * 100 || 0).toFixed(2),
    "%"
  );
  console.log(
    "Error Rate:",
    (data.metrics.errors?.values.rate * 100 || 0).toFixed(2),
    "%"
  );
